...
//!
//! This crate is the Rust kit whole. It holds no code of its own: each part
//! of the kit is its own crate, and this one names them all under one
//! dependency so a caller who wants the kit takes `quo` and a caller who
//! wants one part takes that part.
//!
